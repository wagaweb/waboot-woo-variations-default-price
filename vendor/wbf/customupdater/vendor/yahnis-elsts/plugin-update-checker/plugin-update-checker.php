<?php
/**
 * BasePlugin Update Checker Library 1.6.1
 * http://w-shadow.com/
 * 
...
class PluginUpdateChecker_1_6 {
	...
	public $pluginFile = '';  //BasePlugin filename relative to the plugins directory. Many WP APIs use this to identify plugins.
	public $slug = '';        //BasePlugin slug.
...
class PluginInfo_1_6 {
	...
	public $filename; //BasePlugin filename relative to the plugins directory.
